import {
  AudioEditorCanvas,
  SelectionType,
} from "../components/audio-editor-canvas.js";
...
export async function openEditAudioModal(
  blob: Blob,
...
function updateControls(type: SelectionType, index: number) {
  ...
  if (type === "chunk") {
    ...
    helpText.textContent =
      "Double click waveform to add a split. Single click to select a section or split line.";
