...
export class FeedbackAudioPlayer {
    ...
    getBuffer() { return this.audioBuffer; }
    getIsPlaying() { return this.isPlaying; }
    getPauseTime() { return this.pauseTime; }
    setPauseTime(t: number) { this.pauseTime = t; }
    ...
    private updateProgress = () => {
        ...
        EventBus.emit('feedbackPlaybackProgress', { currentTime, duration: this.audioBuffer.duration });
