...
export function initializeCraftDemoReel() {
  ...
  if (canvas) {
    waveform = new TrimmableWaveform(
      "craft-waveform-canvas",
      ".craft-waveform-container",
    );
  ...
  document
    .getElementById("craft-demo-close")
    ?.addEventListener("click", closeCraftModal);

  document
    .getElementById("craft-add-audio-btn")
    ?.addEventListener("click", () => {
      document.getElementById("craft-audio-upload")?.click();
    });

  document
    .getElementById("craft-audio-upload")
    ?.addEventListener("change", handleAudioUpload);

  document
    .getElementById("craft-play-btn")
    ?.addEventListener("click", playDemoReel);
  document
    .getElementById("craft-save-btn")
    ?.addEventListener("click", saveDemoReel);
}
...
function playDemoReel() {
  ...
  const silenceSecs = Number(
    (document.getElementById("craft-silence-select") as HTMLSelectElement)
      .value,
  );
