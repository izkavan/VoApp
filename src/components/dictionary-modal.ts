...
const ipaSymbols = [
  ...
  // Fricatives 2
  { s: "x", e: "Ba<b>ch</b> (German)" },
  { s: "ɣ", e: "a<b>g</b>ua (Spanish)" },
  { s: "χ", e: "a<b>ch</b>t (German)" },
  { s: "ʁ", e: "pa<b>r</b>is (French)" },
  { s: "ħ", e: "<b>h</b>ammām (Arabic)" },
  { s: "ʕ", e: "<b>‘</b>ayn (Arabic)" },
  { s: "h", e: "<b>h</b>at" },
  { s: "ç", e: "i<b>ch</b> (German)" },

  // Nasals & Liquids
  { s: "m", e: "<b>m</b>an" },
  { s: "n", e: "<b>n</b>o" },
  { s: "ɲ", e: "a<b>gn</b>eau (French)" },
  { s: "ŋ", e: "si<b>ng</b>" },
  { s: "l", e: "<b>l</b>eg" },
  { s: "r", e: "pe<b>rr</b>o (Spanish)" },
  { s: "ʀ", e: "<b>r</b>ouge (French)" },
  { s: "ɾ", e: "be<b>tt</b>er" },

  // Approximants & Affricates
  { s: "j", e: "<b>y</b>es" },
  { s: "w", e: "<b>w</b>e" },
  { s: "ɥ", e: "n<b>u</b>it (French)" },
  { s: "", e: "" },
  { s: "tʃ", e: "<b>ch</b>ain" },
  { s: "dʒ", e: "<b>j</b>am" },
  { s: "", e: "" },
  ...
  { s: "i", e: "s<b>ee</b>" },
  { s: "ɪ", e: "b<b>i</b>t" },
  { s: "y", e: "t<b>u</b> (French)" },
  { s: "ʏ", e: "m<b>ü</b>ssen (German)" },
  { s: "e", e: "caf<b>é</b> (French)" },
  { s: "ø", e: "p<b>eu</b> (French)" },
  { s: "ɛ", e: "b<b>e</b>d" },
  { s: "œ", e: "s<b>œu</b>r (French)" },
  { s: "æ", e: "c<b>a</b>t" },
  { s: "a", e: "p<b>a</b>tte (French)" },
  { s: "", e: "" },
  { s: "", e: "" },
  ...
  { s: "ʌ", e: "c<b>u</b>p" },
  { s: "ɜ", e: "b<b>ir</b>d" },
  { s: "ɐ", e: "bess<b>er</b> (German)" },
  { s: "ã", e: "s<b>an</b>s (French)" },
  { s: "ɛ̃", e: "v<b>in</b> (French)" },
  { s: "œ̃", e: "br<b>un</b> (French)" },
  { s: "ɔ̃", e: "b<b>on</b> (French)" },

  // Suprasegmentals
  { s: "ˈ", e: "<b>Pri</b>mary stress" },
  { s: "ˌ", e: "<b>Sec</b>ondary stress" },
  { s: "ː", e: "Long (e.g. sh<b>oe</b>)" },
  { s: "ˑ", e: "Half-long" },
  { s: ".", e: "Syllable break" },
  { s: "", e: "" },
  { s: "", e: "" },
...
export function initializeDictionaryModal(
  modalEl: HTMLElement,
  ...
  if (!document.getElementById("ipa-popup")) {
    ...
    ipaSymbols.forEach((item) => {
      ...
      btn.addEventListener("mousedown", (e) => {
        ...
        if (activePhoneticInput) {
          ...
          activePhoneticInput.value =
            val.substring(0, start) + sym + val.substring(end);
          activePhoneticInput.selectionStart =
            activePhoneticInput.selectionEnd = start + sym.length;
    ...
    document.addEventListener("mousedown", (e) => {
      ...
      if (
        ipaPopup &&
        !ipaPopup.contains(target) &&
        activePhoneticInput !== target &&
        !(target instanceof Element && target.closest(".dict-ipa-toggle-btn"))
      ) {
        ipaPopup.style.display = "none";
        if (ipaTooltip) ipaTooltip.style.display = "none";
...
function renderModal() {
  ...
  // Attach row events
  document
    .querySelectorAll(".dict-word")
    .forEach((el, i) =>
      el.addEventListener(
        "input",
        (e) => (currentEntries[i].word = (e.target as HTMLInputElement).value),
      ),
    );
  ...
  document.querySelectorAll(".dict-phonetic").forEach((el, i) => {
    ...
    input.addEventListener(
      "input",
      (e) =>
        (currentEntries[i].phonetic = (e.target as HTMLInputElement).value),
    );
  });
  ...
  document
    .querySelectorAll(".dict-meaning")
    .forEach((el, i) =>
      el.addEventListener(
        "input",
        (e) =>
          (currentEntries[i].meaning = (e.target as HTMLInputElement).value),
      ),
    );
  ...
  document.querySelectorAll(".dict-record-btn").forEach((btn) =>
    btn.addEventListener("click", (e) => {
      const index = Number((e.currentTarget as HTMLElement).dataset.index);
  ...
  document.querySelectorAll(".dict-rerecord-btn").forEach((btn) =>
    btn.addEventListener("click", (e) => {
      const index = Number((e.currentTarget as HTMLElement).dataset.index);
      handleRecord(index, e.currentTarget as HTMLElement);
    }),
  ...
  document
    .getElementById("add-dictionary-entry")
  ...
  document
    .getElementById("save-dictionary-btn")
      ...
      try {
        ...
        if (currentProject) {
          window.dispatchEvent(
            new CustomEvent("dictionaryUpdated", {
        ...
        console.error("Failed to save dictionary entries:", error);
        import("../services/EventBus.js").then((module) => {
          module.EventBus.emit("notify", {
            message: "Failed to save dictionary entries. Storage may be full.",
            type: "error",
          });
        });
      }
