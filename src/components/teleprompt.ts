...
export function initializeTeleprompter(projects: Project[]) {
    ...
    const clearButton = document.getElementById('teleprompt-clear-session') as HTMLButtonElement;
    ...
    displayDiv.addEventListener('click', (e) => {
        ...
        if (sentenceEl) {
            ...
            if (activeFile.highlightedSentences.includes(idx)) {
                ...
                displayDiv.querySelectorAll('.sentence.highlighted').forEach(el => el.classList.remove('highlighted'));
